<h3 align="center">I am Saad Tadjaoui. Industrial Engineer, building ML systems that run themselves.</h3>
...
![Claude](https://img.shields.io/badge/-Claude_API-05122A?style=flat&logo=anthropic&logoColor=D97757)&nbsp;
...
![Power BI](https://img.shields.io/badge/-Power_BI-05122A?style=flat)

### 🚀 &nbsp;Featured Projects

| Project | What it does | Stack |
|---|---|---|
| **[Smart Supply Forecaster](https://github.com/SaadTadja/smart-supply-forecaster)** | Closed-loop continuous-training pipeline for retail demand forecasting. Airflow triggers retraining, MLflow versions models, FastAPI serves predictions, Streamlit monitors drift. Fully containerized, tests in CI. | `XGBoost` `Airflow` `MLflow` `FastAPI` `Docker` |
| **[Athena Core](https://github.com/SaadTadja/athena-core)** | Decision-support platform in four analytical layers: KPIs, segmentation and trends, strategic frameworks, then AI modules for sales prediction, anomaly detection, and recommendations. | `Streamlit` `XGBoost` `statsmodels` `Plotly` |
| **[ContinuumSC](https://github.com/SaadTadja/continuumsc)** | MLOps platform for continuous supply-chain operations — demand forecasting paired with interactive inventory optimization under service-level constraints. | `Streamlit` `XGBoost` `SciPy` |
...
**Unlocking GenAI with LangChain** — practical guide to building with LangChain *(August 2025)*

Both on [LinkedIn](https://www.linkedin.com/in/saad-tadjaoui-12a0a5305/).

<br/>

<p align="center"><i>"From notebook to production — that's where engineering begins."</i></p>
